...
export const regions: Region[] = [
  {
    ...
    lng: -77.0428,
    zoom: 10,
    crimeStats: 'Lima has the highest number of reported crimes, with 150,000 incidents last year.',
    crimeTrends: 'Robbery has increased by 15% in the last quarter, while homicides have seen a slight decrease.',
    mostCommonCrimes: ['Aggravated Robbery', 'Assault'],
  },
  {
    id: 'arequipa',
    name: 'Arequipa',
    ...
    lng: -71.5375,
    zoom: 12,
    crimeStats: 'Arequipa reported 45,000 crimes last year, making it the second most affected region.',
    crimeTrends: 'There is a growing concern about extortion, which has risen by 30%. Assaults remain stable.',
    mostCommonCrimes: ['Assault', 'Extortion'],
  },
  {
    id: 'cusco',
    name: 'Cusco',
    ...
    lng: -71.9675,
    zoom: 12,
    crimeStats: 'Cusco had 25,000 reported crimes, with a significant portion related to tourist-targeted theft.',
    crimeTrends: 'While overall crime is lower, there is a seasonal spike in robbery during the high tourist season.',
    mostCommonCrimes: ['Aggravated Robbery', 'Assault'],
  },
  {
    id: 'piura',
    ...
    lng: -80.6328,
    zoom: 11,
    crimeStats: 'Piura faces challenges with organized crime, reporting 35,000 incidents last year.',
    crimeTrends: 'Homicide rates are a major concern, linked to gang activities in the region.',
    mostCommonCrimes: ['Homicide', 'Extortion'],
  }
];
